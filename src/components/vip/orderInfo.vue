                                    ...
                                    <div class="form-box accept-box form-box1">
                                        <dl class="head form-group">
                                            <dd>
                                                ...
                                                <router-link :to="'/payorder?orderid='+orderinfo.id"  v-if='orderinfo.status==1' class="btn-pay">去付款</router-link>
                                                <!---->
                                            </dd>
                                        </dl>
                                        <dl class="form-group">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="5" class="ftable">
                                            <tbody>
                                                ...
                                                <tr v-for='item in goodslist' :key='item.id'>
                                                    ...
                                                    <td align="left">
                                                        <router-link :to="'/goodsinfo/'+item.goods_id" href="/goods/show-92.html">{{item.goods_title}}</router-link>
                                                    </td>
                                                    <td align="center">
      ...
      this.$axios.get(url).then(response => {
        ...
        this.goodslist = response.data.message.goodslist;
         response.data.message.goodslist.forEach(item => {
          this.allAmount += item.quantity * item.real_price;
        });
        this.totalAmount = this.allAmount + this.orderinfo.express_fee;
      });
    }
  }
};
