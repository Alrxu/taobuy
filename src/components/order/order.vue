                        ...
                        <div id="orderForm" name="orderForm" url="">
                            ...
                            <div class="buy-foot clearfix">
                                ...
                                <div class="right-box">
                                    ...
                                    <p class="btn-box">
                                        <a class="btn button" @click='backCart'>返回购物车</a>
                                        <a id="btnSubmit" class="btn submit" @click='payorder'>确认提交</a>
                                    </p>
                                </div>
                            </div>
                        </div>
...
// 导入获取本地数据
import { getLocalData } from "../../common/localStorage.js";
export default {
  components: {
    VDistpicker
  },
  ...
  methods: {
    onSelected(data) {
      // console.log(data)
      // data就是选择的省市区,然后将选择的省市区给order.data 即更新提交给后台的数据
      this.order.area = data;
    },
    getGoodsList() {
      const localGoods = getLocalData();
      // 后台需要的参数
